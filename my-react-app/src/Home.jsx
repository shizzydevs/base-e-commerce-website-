...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-stone-950 text-stone-100 p-4 sm:p-6 lg:p-8 w-full max-w-none">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <header className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-6 border-b border-stone-800">
          <div>
            <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-white">Lebanon Store Hub</h1>
